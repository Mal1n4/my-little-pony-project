    ...
    state: () => ({
        ...
        aradata: [
            ...
            },
            {
                ...
                episode_name: 'Секрет моего роста',
                episode: 'Сезон 2, серия 10',
                episode_img: null,
                episode_comment: [
                    'У Спайка день рождения, и он получил множество подарков от друзей.',
                    'Узнав, как приятно получать подарки, Спайк сначала начинает выклянчивать подарки, а потом — откровенно воровать. Вместе с этим он растёт и становится всё злее, пока не превращается в огромного дракона.'
                ],
                fact: [
